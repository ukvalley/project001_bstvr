                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p15t es-p10b" align="left">
                                                                                        <p style="font-size: 16px; color: #777777; font-family: 'open sans', 'helvetica neue', helvetica, arial, sans-serif;">Welcome to Global Fx and thanks for signing up! You're one step closer to Registration. <strong>Your username is: {{$data['email']}} and password is {{$data['password']}}</strong></p>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p15t" align="center">
                                                                                        <p style="font-size: 16px; color: #777777;">Welcome To Globalfx.world</p>
                                                                                    </td>
                                                                                </tr>
                                                                              <!--  <tr>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                   <!-- <td class="esd-block-image es-p15b" align="center">
                                                                                        <a target="_blank"> <img src="https://" alt="Beretun logo" style="display: block;" title="Beretun logo" width="37"> </a>
                                                                                    </td>-->
                                                                                </tr>
                                                                                <tr>
