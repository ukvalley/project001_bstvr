                ...
                <tbody>
                  @foreach($data as $key=>$value)
                    <tr>
                      ...
                      <td>
                        <a style="color: red;" href="{{url('/')}}/admin/edit?id={{$value->id}}" class="fa fa-edit">Edit</a>
                        <a style="color: green;" href="{{url('/')}}/admin/view?id={{$value->id}}" class="fa fa-eye">View</a>
                      </td>

                      <td>{{$value->plan}}</td>

                      <td> <a href="{{url('/')}}/admin/loginas?id={{$value->id}}" class="btn label-success">Login As</a></td>
